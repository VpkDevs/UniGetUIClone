        ...
        protected override IReadOnlyList<IManagerSource> GetSources_UnSafe()
        {
            ...
            while ((line = p.StandardOutput.ReadLine()) is not null)
            {
                ...
                try
                {
                    ...
                    {
                        string[] elements = Regex.Replace(line, "[1234567890 :.-][AaPp][Mm][\\W]", "").Split(' ', StringSplitOptions.RemoveEmptyEntries) /* Bolt: Avoid Regex allocation for tokenizing whitespace */;
