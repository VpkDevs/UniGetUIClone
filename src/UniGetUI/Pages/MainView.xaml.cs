...
namespace UniGetUI.Interface
{
    ...
    public sealed partial class MainView : UserControl
    {
        ...
        public MainView(AutoSuggestBox mainTextBlock)
        {
            ...
            ToolTipService.SetToolTip(OperationSplitterMenuButton, CoreTools.Translate("More operations options"));
            AutomationProperties.SetName(OperationSplitterMenuButton, CoreTools.Translate("More operations options"));
